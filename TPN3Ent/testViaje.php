...
$colPasajeros=[];
$colPasajeros[0]=new Pasajero("Ana", "Bolena", 22112211, 1231234, 1, 001);
$colPasajeros[1]=new Pasajero("Alejandro", "Dumas", 22221111, 9879876, 2, 002);


//CREACIÓN DEL OBJETO RESPONSABLE NECESARIO PARA CREAR EL VIAJE
$objResponable=new ResponsableV(0245, 666999, "Raphael", "Mefistófeles");


//CREO EL OBJETO $UNVIAJE CON LOS OBJETOS PRECEDENTES
$unViaje=new Viaje(0001, "Samarcanda", 1, [], $objResponable, 1000, 0);
...
do {
    ...
    echo "1. CARGAR NUEVOS PASAJEROS AL VIAJE\n";       //Agrega los colPasajeros al viaje, solicitando por consola la información de los mismos. Debe verificar que el pasajero no esté cargado más de una vez en el viaje.
    ...
    switch($opcion){
        case '1':
            ...
            echo "Elija su opción: ";
            $opcion=solicitarNumeroEntre(1, 3);
            switch ($opcion) {
                case '1':
                    $nuevoPasajero=new Pasajero($nombreNuevoPasajero, $apellidoNuevoPasajero, $dniNuevoPasajero, $telefonoNuevoPasajero, $numeroAsiento, $numeroTicket);
                    break;
                ...
                case '2':
                    ...
                    $nuevoPasajero=new PasajeroVip($nombreNuevoPasajero, $apellidoNuevoPasajero, $dniNuevoPasajero, $telefonoNuevoPasajero, $numeroAsiento, $numeroTicket, $nroViajeroFrecuente, $cantMillas);
                    break;

                case '3':
                    echo "Ingrese el número de viajero necesidades que tiene el pasajero: ";
                    $necesidades=trim(fgets(STDIN));
                    $nuevoPasajero=new PasajeroConNecesidades($nombreNuevoPasajero, $apellidoNuevoPasajero, $dniNuevoPasajero, $telefonoNuevoPasajero, $numeroAsiento, $numeroTicket, $necesidades);
                    break;
            }
            
            //ACTUALIZACIÓN DEL ARREGLO DE OBJETOS PASAJERO
            $montoPasajero=$unViaje->venderPasaje($nuevoPasajero);
            echo $montoPasajero."\n";
            break;
            ...
            switch($eleccion){
                case '1':
                    ...
                    switch ($seleccion) {
                        ...
                        case '3':
                            echo "Ingrese la nueva cantidad máxima de colPasajeros: ";
