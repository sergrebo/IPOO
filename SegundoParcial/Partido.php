...
public function __toString(){
    ...
    /** Implementar el método coeficientePartido() en la clase Partido el cual retorna el valor obtenido por el coeficiente base, multiplicado por la cantidad de 
     *  goles y la cantidad de jugadores. Redefinir dicho método según corresponda.
     * 
     */
    public function coeficientePartido(){
        ...
        $numeroJugadores=($this->getObjEquipo1()->getCantJugadores())*2;
        $coefPartido=$coefBase*$golesTotales*$numeroJugadores;
        return $coefPartido;
    }
}
?>